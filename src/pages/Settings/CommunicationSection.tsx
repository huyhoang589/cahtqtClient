    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
      ...
      {previewCert && (
        <div style={{
          ...
          <div style={{ fontSize: "var(--cahtqt-font-size-sm)", fontWeight: "var(--cahtqt-font-weight-bold)", color: "var(--cahtqt-text-on-light)", marginBottom: 4 }}>
            Certificate Preview
          </div>
      ...
      {commCert && (
        <div style={{
          ...
          <div style={{ fontSize: "var(--cahtqt-font-size-sm)", fontWeight: "var(--cahtqt-font-weight-bold)", color: "var(--cahtqt-color-success-dark)", marginBottom: 4 }}>
            Current Recipient
          </div>
