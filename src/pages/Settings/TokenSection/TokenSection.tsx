...
export default function TokenSection({ pkcs11Mode, pkcs11ManualPath, onPkcs11ModeChange, onPkcs11ManualPathChange }: Props) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      />
      <div style={{ borderBottom: "1px solid var(--cahtqt-border-light)", margin: "8px 0" }} />
      ...
      {tokenStatus === "logged_in" && cert_cn && (
        <div
          style={{
            ...
            border: "1px solid var(--cahtqt-color-success)",
      ...
      {senderCert && (
        ...
        >
          ...
          <div style={{ color: "var(--cahtqt-text-on-light)" }}>{senderCert.display_name}</div>
          <div style={{ color: "var(--cahtqt-text-muted)" }}>{senderCert.email}</div>
          <div style={{ color: "var(--cahtqt-text-muted)" }}>
