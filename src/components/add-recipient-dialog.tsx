        ...
        >
          ...
          <div className="dialog-body" style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            {certInfo && (
              <div
                style={{
                  background: "var(--cahtqt-bg-app)",
                  borderRadius: "var(--cahtqt-radius-sm)",
                  padding: "10px 12px",
                  border: `1px solid ${isExpired ? "var(--cahtqt-color-danger)" : "var(--cahtqt-border-dark)"}`,
                  fontSize: "var(--cahtqt-font-size-sm)",
                }}
              >
                <div style={{ marginBottom: 4, fontWeight: "var(--cahtqt-font-weight-semibold)" }}>
                  Certificate Preview
                </div>
                {isExpired && (
                  <div style={{ color: "var(--cahtqt-color-danger)", marginBottom: 6 }}>
