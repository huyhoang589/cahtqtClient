...
export default function LoginTokenModal({ open, onClose, onSuccess }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setPin(""); // always clear PIN from component state, success or error
      setLoading(false);
    }
  };
      ...
      <Dialog.Portal>
        ...
        >
          <div style={{ padding: "32px", textAlign: "center" }}>
            ...
            <p style={{ fontSize: "var(--cahtqt-font-size-md)", color: "var(--cahtqt-color-warning-light)", marginBottom: 24 }}>
            ...
            <div style={{ position: "relative", marginBottom: 8 }}>
              <input
                ...
                autoComplete="off"
                disabled={loading}
                style={{ marginBottom: 0, height: 36, borderRadius: "var(--cahtqt-radius-sm)", paddingRight: 36 }}
              />
              <button
                type="button"
                ...
                style={{
                  ...
                  border: "none",
                  color: "var(--cahtqt-text-secondary)",
                  padding: 0,
                  cursor: "pointer",
                  width: 20,
                  height: 20,
            ...
            {error && (
              <div
                style={{
                  color: "var(--cahtqt-color-warning-lighter)",
                  fontSize: "var(--cahtqt-font-size-sm)",
                  marginBottom: 12,
                  textAlign: "left",
            ...
            <button
              ...
              style={{
                width: "100%",
                height: 44,
                background: "var(--cahtqt-bg-black)",
                color: "var(--cahtqt-text-white)",
                border: "none",
                borderRadius: "var(--cahtqt-radius-sm)",
                fontSize: "var(--cahtqt-font-size-md)",
