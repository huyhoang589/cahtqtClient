    ...
    <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
      ...
      {actionStatus !== "idle" && (
        <span style={{ fontSize: 11, minWidth: 14, color:
          actionStatus === "done" ? "var(--cahtqt-color-success)" :
          actionStatus === "error" ? "var(--cahtqt-color-danger)" :
          "var(--cahtqt-text-muted)" }}>
      ...
      <button
        ...
        style={{ color: "var(--cahtqt-color-accent-indigo)" }}
      ...
      <button
        ...
        style={{ color: "var(--cahtqt-color-primary-dark-alt)" }}
        onMouseEnter={e => (e.currentTarget.style.background = "rgba(0,0,0,0.06)")}
        onMouseLeave={e => (e.currentTarget.style.background = "")}
      >📤</button>
      ...
      <button
        ...
        disabled={actionStatus === "loading"}
        title="Remove member"
        style={{ color: "var(--cahtqt-color-danger)" }}
        onMouseEnter={e => (e.currentTarget.style.background = "rgba(0,0,0,0.06)")}
        onMouseLeave={e => (e.currentTarget.style.background = "")}
      >×</button>
